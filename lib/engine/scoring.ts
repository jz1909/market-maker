...
export function calculateTradePnL(trade:Trade, correctAnswer:number):{makerPnL:number; takerPnL:number}{
...
export function calculateRoundPnL(trades: Trade[], correctAnswer:number):{makerPnL:number, takerPnL:number}{
    let totalTakerPnL = 0;
    let totalMakerPnL = 0;
