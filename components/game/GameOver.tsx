    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-100 p-4">
      <div className="flex flex-col items-center justify-center bg-white rounded-xl shadow-lg p-8 max-w-md w-full">
        ...
        <div className="grid grid-cols-2 gap-4 mb-8">
          <div
            className={`p-6 rounded-lg flex flex-col items-center ${makerWins > takerWins ? "bg-green-100 border-2 border-green-500" : "bg-gray-100"}`}
          >
          ...
          <div
            className={`p-6 rounded-lg flex flex-col items-center ${takerWins > makerWins ? "bg-green-100 border-2 border-green-500" : "bg-gray-100"}`}
          >
        ...
        <Button className="p-5 font-bold" onClick={() => router.push("/")}>
          Go back home
        </Button>
      </div>
    </div>
