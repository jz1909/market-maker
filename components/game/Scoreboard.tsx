...
export function Scoreboard({
  ...
  return (
    <div className="flex justify-around items-center bg-linear-to-r from-blue-400 to-green-500  p-4 mb-4">
      <div className="flex flex-col items-center p-3 rounded-lg bg-blue-100 border-2 border-blue-500">
      ...
      <div className="flex flex-col items-center p-3 rounded-lg bg-green-100 border-2 border-green-600">
