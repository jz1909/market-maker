...
export function Scoreboard({
  ...
  return (
    <div className="flex justify-around items-center bg-gray-100 rounded-lg p-4 mb-4">
      <div
        className={`flex flex-col items-center p-3 rounded-lg ${currentRole === "MAKER" ? "bg-blue-100 border-2 border-blue-500" : ""}`}
      >
      ...
      <div
        className={`flex flex-col items-center p-3 rounded-lg ${currentRole === "TAKER" ? "bg-green-100 border-2 border-green-500" : ""}`}
      >
